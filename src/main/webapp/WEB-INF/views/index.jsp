...
<title>Insert title here</title>
	...
	<script type="text/javascript">
		$(function(){
			/*
			$('#memo_img').click(function(){
				$("#frm").attr("action", "${pageContext.request.contextPath}/memo/list");
				$("#frm").submit();
			})*/
		})
	</script>
...
<a href="${pageContext.request.contextPath}/memo/list">
	<img id="memo_img" src="${pageContext.request.contextPath}/resources/img/icons/mail-green.png"/>
</a>
